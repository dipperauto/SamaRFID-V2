  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(900px 500px at 0% 0%, rgba(242, 103, 22, 0.20), transparent 60%),
      ...
      <div className="pointer-events-none fixed -top-28 -left-28 h-[650px] w-[650px] rounded-full bg-[#f26716]/25 blur-3xl bg-orb-anim" />
